...
def log_startup() -> None:
    logger.info(
        "face_service_started database=%s debug_frames=%s laravel_base_url=%s model=%s detector=%s fallback_detector=%s anti_spoofing_model=%s anti_spoofing=%s require_anti_spoofing=%s deepface_available=%s",
        ...
        settings.anti_spoofing_model_path,
...
def health(settings: Settings = Depends(get_settings)) -> dict:
    return {
        ...
        "anti_spoofing_model_path": str(settings.anti_spoofing_model_path) if settings.anti_spoofing_model_path else None,
        "anti_spoofing_input_size": settings.anti_spoofing_input_size,
        "anti_spoofing_crop_scale": settings.anti_spoofing_crop_scale,
        "anti_spoofing_real_threshold": settings.anti_spoofing_real_threshold,
        "anti_spoofing_fake_threshold": settings.anti_spoofing_fake_threshold,
